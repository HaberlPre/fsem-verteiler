...
App = (function() {
  ...
  console.log("hola video geschichte");
  initFirebase(firebase);
  id = sessionStorage.getItem("userID");
  console.log(id);
  document.getElementById("1424265469").value = id; //value bei finalem Bogen anpassen
  setupInput();
  ...
  $('#bootstrapForm').submit(function (event) {
      ...
      $('#bootstrapForm').ajaxSubmit({
          ...
          error: function () {
              ...
              //window.location = '3_video_Funktion.html'
